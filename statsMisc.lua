...
function stats.spendStars(n)
    return "Are you sure? This action costs "..tostring(n).." Purple Stars."
end
...
stats.levelList = {
    ...
    {filename = "!A-2 Disastrous Deeps.lvlx"        , name = "Disastrous Deeps",     type = stats.LVL_LOST,  description = "When you swim where the sun doesn't shine, your safety is never guaranteed. Here, Rammerheads coordinate their movement patterns for more efficient travel."},
    {filename = "!B-1 Swooper Drop Sneak.lvlx"      , name = "Swooper Drop Sneak",   type = stats.LVL_LOST,  description = "By some anomaly, this cave has Swoopers sitting at the top of the ecosystem, hence their massive size. At least they're bouncy!"},
