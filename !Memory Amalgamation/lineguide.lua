...
local propNames = {"lineSpeed", "jumpSpeed", "useHiddenLines", "extendedDespawnTimer", "fallWhenInactive", 
	"activateOnStanding", "activateNearby", "sensorAlignH", "sensorAlignV", "sensorOffsetX", "sensorOffsetY", "buoyant"}
...
local function initProps(npc)
	local globalProps = lineguide.properties[npc.id] or {}
	
	if not lineguide.speeds[npc.id] then
		local id = npc.id
