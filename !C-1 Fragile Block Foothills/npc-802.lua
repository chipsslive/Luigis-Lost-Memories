...
npcManager.setNpcSettings(weakGraySettings)
...
--Register events
function weakGray.onInitAPI()
	--npcManager.registerEvent(npcID, weakGray, "onTickNPC")
	npcManager.registerEvent(npcID, weakGray, "onTickEndNPC")
	--npcManager.registerEvent(npcID, weakGray, "onDrawNPC")
	registerEvent(weakGray, "onNPCKill")
end

function weakGray.onTickEndNPC(v)
	...
	v.animationFrame = 3 - data.strength
...
function weakGray.onNPCKill(eventObj, v, killReason, culprit)
