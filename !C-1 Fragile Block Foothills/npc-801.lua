...
npcManager.setNpcSettings(strongBrownSettings)
...
--Register events
function strongBrown.onInitAPI()
	--npcManager.registerEvent(npcID, strongBrown, "onTickNPC")
	npcManager.registerEvent(npcID, strongBrown, "onTickEndNPC")
	--npcManager.registerEvent(npcID, strongBrown, "onDrawNPC")
	registerEvent(strongBrown, "onNPCKill")
end

function strongBrown.onTickEndNPC(v)
...
function strongBrown.onNPCKill(eventObj, v, killReason, culprit)
