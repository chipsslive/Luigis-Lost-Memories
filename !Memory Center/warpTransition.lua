...
do
    ...
    function warpTransition.TRANSITION_CROSSFADE()
        ...
        Graphics.drawScreen{texture = buffer,color = Color.white.. opacity,priority = 6}
    end
    ...
    function warpTransition.TRANSITION_MELT() -- It's the thing from doom :v
        ...
        Graphics.drawScreen{texture = buffer,priority = 6,shader = meltShader,uniforms = {yOffsets = yOffsets}}
    end
...
warpTransition.transitionSpeeds = {
    [warpTransition.TRANSITION_FADE     ] = 128, -- How long it takes to fade in/out.
