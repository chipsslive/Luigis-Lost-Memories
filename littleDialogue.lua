...
function littleDialogue.create(args)
    ...
    box.silentOpen = args.silentOpen or false
    ...
    if not box.silent and box.settings.openSoundEnabled and not box.silentOpen then
...
function boxInstanceFunctions:close()
    ...
    if not self.silent and self.settings.closeSoundEnabled and answer == nil and not self.silentOpen then
